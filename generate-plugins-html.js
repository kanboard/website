        ...
        <div class="plugin-info">
          ...
          <dd>
            ...
            <div class="structure-list">
              {{#has_schema}}
              <svg class="icon orange" data-tippy-content="This plugin includes database changes.">
              ...
              <svg
                class="icon green"
                data-tippy-content="This plugin does not contain any database changes."
              >
                <use xlink:href="#database-check-icon"></use>
              </svg>
              {{/has_schema}}
              {{#has_hooks}}
              <svg class="icon orange" data-tippy-content="The plugin incorporates Kanboard hooks.">
              ...
              <svg
                class="icon green"
                data-tippy-content="The plugin does not incorporate any Kanboard hooks."
              >
                <use xlink:href="#hooks-check-icon"></use>
              </svg>
              {{/has_hooks}}
              {{#has_overrides}}
              <svg class="icon orange" data-tippy-content="This plugin overrides existing templates.">
              ...
              <svg
                class="icon green"
                data-tippy-content="This plugin does not contain any template overrides."
              >
